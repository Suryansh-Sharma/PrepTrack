...
public class ForgotPasswordCommandHandler {
    ...
    public ForgotPasswordCommandHandler(AppUserRepository appUserRepository, PasswordResetTokenRepository passwordResetTokenRepository, TokenService tokenService) {
